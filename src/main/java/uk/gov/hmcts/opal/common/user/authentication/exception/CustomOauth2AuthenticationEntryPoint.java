...
public class CustomOauth2AuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        //We cannot look up the userid using the user service as that requires the access token, but it's invalid.
        //Instead we are using the 'oid' from the JWT, falling back to an IP address if not available.
